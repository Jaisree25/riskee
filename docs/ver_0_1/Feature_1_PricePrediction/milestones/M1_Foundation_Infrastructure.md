...
- [ ] **T2.2** - Configure TimescaleDB service
  - [ ] Add TimescaleDB container to docker-compose
...
- [ ] **T2.3** - Configure Redis service
  - [ ] Add Redis 7 container to docker-compose
  - [ ] Configure persistence (RDB snapshots)
  - [ ] Set up port mapping (6379)
  - [ ] Configure memory limits (8GB)
  - [ ] Enable TLS (optional for dev)
  - **Assigned to:** Backend Dev
  - **Estimated time:** 2 hours
  - **Blocked by:** T2.1

- [ ] **T2.4** - Configure NATS JetStream service
  - [ ] Add NATS container to docker-compose
  - [ ] Configure file storage for streams
  - [ ] Set up port mapping (4222, 8222 for monitoring)
  - [ ] Create JetStream configuration file
...
- [ ] **T2.5** - Configure Qdrant vector database
  ...
  - [ ] Configure port mapping (6333 for API, 6334 for gRPC)
...
- [ ] **T2.6** - Configure Ollama service (LLM)
  ...
  - [ ] Configure GPU passthrough (NVIDIA runtime)
  - [ ] Set up volume for model storage
  - [ ] Configure port mapping (11434)
  - [ ] Pull Llama 3.1 8B model (q4_K_M quantized)
...
- [ ] **T4.3** - Create NATS test publisher/subscriber
  - [ ] Write test script to publish sample messages
  - [ ] Write test script to consume messages
...
- [ ] **T9.3** - Create developer onboarding guide
  - [ ] Prerequisites (Docker, GPU drivers, etc.)
